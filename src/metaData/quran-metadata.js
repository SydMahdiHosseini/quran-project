...
export var QuranData = {};

//------------------ Sura Data ---------------------

QuranData.Sura = [
	// [start, ayas, order, rukus, name, tname, ename, type, startPage]
	[],
	[0, 7, 5, 1, 'الفاتحة', "Al-Faatiha", 'The Opening', 'Meccan', 1],
	[7, 286, 87, 40, 'البقرة', "Al-Baqara", 'The Cow', 'Medinan', 2],
	[293, 200, 89, 20, 'آل عمران', "Aal-i-Imraan", 'The Family of Imraan', 'Medinan', 50],
	[493, 176, 92, 24, 'النساء', "An-Nisaa", 'The Women', 'Medinan', 77],
	[669, 120, 112, 16, 'المائدة', "Al-Maaida", 'The Table', 'Medinan', 106],
	[789, 165, 55, 20, 'الأنعام', "Al-An'aam", 'The Cattle', 'Meccan', 128],
	[954, 206, 39, 24, 'الأعراف', "Al-A'raaf", 'The Heights', 'Meccan', 151],
	[1160, 75, 88, 10, 'الأنفال', "Al-Anfaal", 'The Spoils of War', 'Medinan', 177],
	[1235, 129, 113, 16, 'التوبة', "At-Tawba", 'The Repentance', 'Medinan', 187],
	[1364, 109, 51, 11, 'يونس', "Yunus", 'Jonas', 'Meccan', 208],
	[1473, 123, 52, 10, 'هود', "Hud", 'Hud', 'Meccan', 221],
	[1596, 111, 53, 12, 'يوسف', "Yusuf", 'Joseph', 'Meccan', 235],
	[1707, 43, 96, 6, 'الرعد', "Ar-Ra'd", 'The Thunder', 'Medinan', 249],
	[1750, 52, 72, 7, 'ابراهيم', "Ibrahim", 'Abraham', 'Meccan', 255],
	[1802, 99, 54, 6, 'الحجر', "Al-Hijr", 'The Rock', 'Meccan', 262],
	[1901, 128, 70, 16, 'النحل', "An-Nahl", 'The Bee', 'Meccan', 267],
	[2029, 111, 50, 12, 'الإسراء', "Al-Israa", 'The Night Journey', 'Meccan', 282],
	[2140, 110, 69, 12, 'الكهف', "Al-Kahf", 'The Cave', 'Meccan', 293],
	[2250, 98, 44, 6, 'مريم', "Maryam", 'Mary', 'Meccan', 305],
	[2348, 135, 45, 8, 'طه', "Taa-Haa", 'Taa-Haa', 'Meccan', 312],
	[2483, 112, 73, 7, 'الأنبياء', "Al-Anbiyaa", 'The Prophets', 'Meccan', 322],
	[2595, 78, 103, 10, 'الحج', "Al-Hajj", 'The Pilgrimage', 'Medinan', 332],
	[2673, 118, 74, 6, 'المؤمنون', "Al-Muminoon", 'The Believers', 'Meccan', 342],
	[2791, 64, 102, 9, 'النور', "An-Noor", 'The Light', 'Medinan', 350],
	[2855, 77, 42, 6, 'الفرقان', "Al-Furqaan", 'The Criterion', 'Meccan', 359],
	[2932, 227, 47, 11, 'الشعراء', "Ash-Shu'araa", 'The Poets', 'Meccan', 367],
	[3159, 93, 48, 7, 'النمل', "An-Naml", 'The Ant', 'Meccan', 377],
	[3252, 88, 49, 8, 'القصص', "Al-Qasas", 'The Stories', 'Meccan', 385],
	[3340, 69, 85, 7, 'العنكبوت', "Al-Ankaboot", 'The Spider', 'Meccan', 396],
	[3409, 60, 84, 6, 'الروم', "Ar-Room", 'The Romans', 'Meccan', 404],
	[3469, 34, 57, 3, 'لقمان', "Luqman", 'Luqman', 'Meccan', 411],
	[3503, 30, 75, 3, 'السجدة', "As-Sajda", 'The Prostration', 'Meccan', 415],
	[3533, 73, 90, 9, 'الأحزاب', "Al-Ahzaab", 'The Clans', 'Medinan', 418],
	[3606, 54, 58, 6, 'سبإ', "Saba", 'Sheba', 'Meccan', 428],
	[3660, 45, 43, 5, 'فاطر', "Faatir", 'The Originator', 'Meccan', 434],
	[3705, 83, 41, 5, 'يس', "Yaseen", 'Yaseen', 'Meccan', 440],
	[3788, 182, 56, 5, 'الصافات', "As-Saaffaat", 'Those drawn up in Ranks', 'Meccan', 446],
	[3970, 88, 38, 5, 'ص', "Saad", 'The letter Saad', 'Meccan', 453],
	[4058, 75, 59, 8, 'الزمر', "Az-Zumar", 'The Groups', 'Meccan', 458],
	[4133, 85, 60, 9, 'غافر', "Al-Ghaafir", 'The Forgiver', 'Meccan', 467],
	[4218, 54, 61, 6, 'فصلت', "Fussilat", 'Explained in detail', 'Meccan', 477],
	[4272, 53, 62, 5, 'الشورى', "Ash-Shura", 'Consultation', 'Meccan', 483],
	[4325, 89, 63, 7, 'الزخرف', "Az-Zukhruf", 'Ornaments of gold', 'Meccan', 489],
	[4414, 59, 64, 3, 'الدخان', "Ad-Dukhaan", 'The Smoke', 'Meccan', 496],
	[4473, 37, 65, 4, 'الجاثية', "Al-Jaathiya", 'Crouching', 'Meccan', 499],
	[4510, 35, 66, 4, 'الأحقاف', "Al-Ahqaf", 'The Dunes', 'Meccan', 502],
	[4545, 38, 95, 4, 'محمد', "Muhammad", 'Muhammad', 'Medinan', 507],
	[4583, 29, 111, 4, 'الفتح', "Al-Fath", 'The Victory', 'Medinan', 511],
	[4612, 18, 106, 2, 'الحجرات', "Al-Hujuraat", 'The Inner Apartments', 'Medinan', 515],
	[4630, 45, 34, 3, 'ق', "Qaaf", 'The letter Qaaf', 'Meccan', 518],
	[4675, 60, 67, 3, 'الذاريات', "Adh-Dhaariyat", 'The Winnowing Winds', 'Meccan', 520],
	[4735, 49, 76, 2, 'الطور', "At-Tur", 'The Mount', 'Meccan', 523],
	[4784, 62, 23, 3, 'النجم', "An-Najm", 'The Star', 'Meccan', 526],
	[4846, 55, 37, 3, 'القمر', "Al-Qamar", 'The Moon', 'Meccan', 528],
	[4901, 78, 97, 3, 'الرحمن', "Ar-Rahmaan", 'The Beneficent', 'Medinan', 531],
	[4979, 96, 46, 3, 'الواقعة', "Al-Waaqia", 'The Inevitable', 'Meccan', 534],
	[5075, 29, 94, 4, 'الحديد', "Al-Hadid", 'The Iron', 'Medinan', 537],
	[5104, 22, 105, 3, 'المجادلة', "Al-Mujaadila", 'The Pleading Woman', 'Medinan', 542],
	[5126, 24, 101, 3, 'الحشر', "Al-Hashr", 'The Exile', 'Medinan', 545],
	[5150, 13, 91, 2, 'الممتحنة', "Al-Mumtahana", 'She that is to be examined', 'Medinan', 549],
	[5163, 14, 109, 2, 'الصف', "As-Saff", 'The Ranks', 'Medinan', 551],
	[5177, 11, 110, 2, 'الجمعة', "Al-Jumu'a", 'Friday', 'Medinan', 553],
	[5188, 11, 104, 2, 'المنافقون', "Al-Munaafiqoon", 'The Hypocrites', 'Medinan', 554],
	[5199, 18, 108, 2, 'التغابن', "At-Taghaabun", 'Mutual Disillusion', 'Medinan', 556],
	[5217, 12, 99, 2, 'الطلاق', "At-Talaaq", 'Divorce', 'Medinan', 558],
	[5229, 12, 107, 2, 'التحريم', "At-Tahrim", 'The Prohibition', 'Medinan', 560],
	[5241, 30, 77, 2, 'الملك', "Al-Mulk", 'The Sovereignty', 'Meccan', 562],
	[5271, 52, 2, 2, 'القلم', "Al-Qalam", 'The Pen', 'Meccan', 564],
	[5323, 52, 78, 2, 'الحاقة', "Al-Haaqqa", 'The Reality', 'Meccan', 566],
	[5375, 44, 79, 2, 'المعارج', "Al-Ma'aarij", 'The Ascending Stairways', 'Meccan', 568],
	[5419, 28, 71, 2, 'نوح', "Nooh", 'Noah', 'Meccan', 570],
	[5447, 28, 40, 2, 'الجن', "Al-Jinn", 'The Jinn', 'Meccan', 572],
	[5475, 20, 3, 2, 'المزمل', "Al-Muzzammil", 'The Enshrouded One', 'Meccan', 574],
	[5495, 56, 4, 2, 'المدثر', "Al-Muddaththir", 'The Cloaked One', 'Meccan', 575],
	[5551, 40, 31, 2, 'القيامة', "Al-Qiyaama", 'The Resurrection', 'Meccan', 577],
	[5591, 31, 98, 2, 'الانسان', "Al-Insaan", 'Man', 'Medinan', 578],
	[5622, 50, 33, 2, 'المرسلات', "Al-Mursalaat", 'The Emissaries', 'Meccan', 580],
	[5672, 40, 80, 2, 'النبإ', "An-Naba", 'The Announcement', 'Meccan', 582],
	[5712, 46, 81, 2, 'النازعات', "An-Naazi'aat", 'Those who drag forth', 'Meccan', 583],
	[5758, 42, 24, 1, 'عبس', "Abasa", 'He frowned', 'Meccan', 585],
	[5800, 29, 7, 1, 'التكوير', "At-Takwir", 'The Overthrowing', 'Meccan', 586],
	[5829, 19, 82, 1, 'الإنفطار', "Al-Infitaar", 'The Cleaving', 'Meccan', 587],
	[5848, 36, 86, 1, 'المطففين', "Al-Mutaffifin", 'Defrauding', 'Meccan', 587],
	[5884, 25, 83, 1, 'الإنشقاق', "Al-Inshiqaaq", 'The Splitting Open', 'Meccan', 589],
	[5909, 22, 27, 1, 'البروج', "Al-Burooj", 'The Constellations', 'Meccan', 590],
	[5931, 17, 36, 1, 'الطارق', "At-Taariq", 'The Morning Star', 'Meccan', 591],
	[5948, 19, 8, 1, 'الأعلى', "Al-A'laa", 'The Most High', 'Meccan', 591],
	[5967, 26, 68, 1, 'الغاشية', "Al-Ghaashiya", 'The Overwhelming', 'Meccan', 592],
	[5993, 30, 10, 1, 'الفجر', "Al-Fajr", 'The Dawn', 'Meccan', 593],
	[6023, 20, 35, 1, 'البلد', "Al-Balad", 'The City', 'Meccan', 594],
	[6043, 15, 26, 1, 'الشمس', "Ash-Shams", 'The Sun', 'Meccan', 595],
	[6058, 21, 9, 1, 'الليل', "Al-Lail", 'The Night', 'Meccan', 595],
	[6079, 11, 11, 1, 'الضحى', "Ad-Dhuhaa", 'The Morning Hours', 'Meccan', 596],
	[6090, 8, 12, 1, 'الشرح', "Ash-Sharh", 'The Consolation', 'Meccan', 596],
	[6098, 8, 28, 1, 'التين', "At-Tin", 'The Fig', 'Meccan', 597],
	[6106, 19, 1, 1, 'العلق', "Al-Alaq", 'The Clot', 'Meccan', 597],
	[6125, 5, 25, 1, 'القدر', "Al-Qadr", 'The Power, Fate', 'Meccan',598 ],
	[6130, 8, 100, 1, 'البينة', "Al-Bayyina", 'The Evidence', 'Medinan', 598],
	[6138, 8, 93, 1, 'الزلزلة', "Az-Zalzala", 'The Earthquake', 'Medinan', 599],
	[6146, 11, 14, 1, 'العاديات', "Al-Aadiyaat", 'The Chargers', 'Meccan',599],
	[6157, 11, 30, 1, 'القارعة', "Al-Qaari'a", 'The Calamity', 'Meccan', 600],
	[6168, 8, 16, 1, 'التكاثر', "At-Takaathur", 'Competition', 'Meccan', 600],
	[6176, 3, 13, 1, 'العصر', "Al-Asr", 'The Declining Day, Epoch', 'Meccan', 601],
	[6179, 9, 32, 1, 'الهمزة', "Al-Humaza", 'The Traducer', 'Meccan', 601],
	[6188, 5, 19, 1, 'الفيل', "Al-Fil", 'The Elephant', 'Meccan', 601],
	[6193, 4, 29, 1, 'قريش', "Quraish", 'Quraysh', 'Meccan', 602],
	[6197, 7, 17, 1, 'الماعون', "Al-Maa'un", 'Almsgiving', 'Meccan', 602],
	[6204, 3, 15, 1, 'الكوثر', "Al-Kawthar", 'Abundance', 'Meccan', 602],
	[6207, 6, 18, 1, 'الكافرون', "Al-Kaafiroon", 'The Disbelievers', 'Meccan', 603],
	[6213, 3, 114, 1, 'النصر', "An-Nasr", 'Divine Support', 'Medinan', 603],
	[6216, 5, 6, 1, 'المسد', "Al-Masad", 'The Palm Fibre', 'Meccan', 603],
	[6221, 4, 22, 1, 'الإخلاص', "Al-Ikhlaas", 'Sincerity', 'Meccan', 604],
	[6225, 5, 20, 1, 'الفلق', "Al-Falaq", 'The Dawn', 'Meccan', 604],
	[6230, 6, 21, 1, 'الناس', "An-Naas", 'Mankind', 'Meccan', 604],
	[6236, 1]
];
